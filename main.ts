import { app, BrowserWindow, Tray, Menu, screen, Notification, autoUpdater, dialog, remote } from 'electron';
...
autoUpdater.on('checking-for-update', () => {
  sendStatus('Checando atualizações...');
});

autoUpdater.on('update-available', info => {
  sendStatus('Atualização disponível.');
});
